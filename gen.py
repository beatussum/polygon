...
def many_inclusions(n):
    ...
    for i in range(n):
        ...
        polys[i] = (bottom_left, (top_right[0], bottom_left[1]), top_right, (bottom_left[0], top_right[1]))
    return polys
...
def no_inclusions(n):
    ...
    bottom_left = (0, 0)
    top_right = (1, 1)
    polys[0] = (bottom_left, (top_right[0], bottom_left[1]), top_right, (bottom_left[0], top_right[1]))
    mid = (n - 1) // 2 + 1
